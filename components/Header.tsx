...
const Header: React.FC<HeaderProps> = ({ onGoHome }) => {
  ...
  return (
    <>
      <header className="border-b-2 border-brand-primary pb-4 flex justify-between items-start">
        {/* Left Side */}
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-brand-text-secondary mt-2 text-sm"><span className="font-semibold text-brand-text-main">팀:</span> Dying Mouse(주근지)</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2 flex-shrink-0 mt-1">
           <button
            ...
            <button
              ...
              aria-label="팀 소개 보기"
            >
              <MouseIcon className="w-5 h-5 text-brand-secondary" />
